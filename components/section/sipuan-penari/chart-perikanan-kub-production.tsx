...
export default function ChartPerikananKUBProduction({
  year,
  chartData,
}: Props) {
              ...
              <div className="max-h-[60vh] overflow-y-auto rounded-md border">
                <TabsContent value="komoditi" className="p-0">
                  <TableMonthly
                    ...
                    unit="Ton"
                    tableHeadColspan={
                      "Jumlah Produksi KUB Bulanan Tahun " + year
                    }
                    tableFooterTotal="Total Seluruh Produksi KUB"
                    dataChart={dataChart}
                  />
                </TabsContent>
                <TabsContent value="kecamatan" className="p-0">
                  <TableDistrictly
                    ...
                    unit="Ton"
                    tableHeadColspan={
                      "Jumlah Produksi KUB Komoditi Tahun " + year
                    }
                    tableFooterTotal="Total Seluruh Produksi KUB"
