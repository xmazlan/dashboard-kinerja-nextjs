...
export default function ChartPerikananUPIFisheryProduct({
  year,
  chartData,
}: Props) {
  ...
  const title =
    "Data Produksi Unit Pengolahan Ikan (UPI) Pengolahan Hasil Perikanan";
              ...
              <div className="max-h-[60vh] overflow-y-auto rounded-md border">
                <TabsContent value="komoditi" className="p-0">
                  <TableMonthly
                    ...
                    unit="Ton"
                    tableHeadColspan={
                      "Jumlah Produksi UPI Bulanan Tahun " + year
                    }
                    tableFooterTotal="Total Seluruh Produksi UPI"
                    dataChart={dataChart}
                  />
                </TabsContent>
                <TabsContent value="kecamatan" className="p-0">
                  <TableDistrictly
                    ...
                    unit="Ton"
                    tableHeadColspan={
                      "Jumlah Produksi UPI Komoditi Tahun " + year
                    }
                    tableFooterTotal="Total Seluruh Produksi UPI"
