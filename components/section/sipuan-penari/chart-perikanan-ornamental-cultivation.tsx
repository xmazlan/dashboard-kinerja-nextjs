...
export default function ChartPerikananOrnamentalCultivation({
  year,
  chartData,
}: Props) {
  ...
  const title = "Data Produksi Budidaya Ikan Hias";
              ...
              <div className="max-h-[60vh] overflow-y-auto rounded-md border">
                <TabsContent value="komoditi" className="p-0">
                  <TableMonthly
                    ...
                    unit="Ekor"
                    tableHeadColspan={
                      "Jumlah Produksi Ikan Hias Bulanan Tahun " + year
                    }
                ...
                <TabsContent value="kecamatan" className="p-0">
                  <TableDistrictly
                    ...
                    unit="Ekor"
                    tableHeadColspan={
                      "Jumlah Produksi Ikan Hias Komoditi Tahun " + year
                    }
                    tableFooterTotal="Total Seluruh Produksi Budidaya"
