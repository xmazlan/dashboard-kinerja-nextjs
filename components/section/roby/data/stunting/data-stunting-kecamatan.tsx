  ...
  return (
    <div className="w-full h-full">
      <CardComponent
        ...
        title="Layanan Penangan Stunting per Kecamatan"
        description={
          <>
            Last update: {apiData?.last_get ?? ""}
            <br />
            <span className="italic text-xs">(Sumber : Stunting Sweeper)</span>
            <div className="mt-1 text-xs">Kecamatan: {itemsSorted.length}</div>
          </>
        }
      >
        {isLoadingApiData ? (
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="text-[11px] md:text-xs font-semibold uppercase opacity-90">
                          Total Balita (Semua Kecamatan)
                        </div>
                        <div className="text-[10px] md:text-[11px] opacity-80">
                          Akumulasi ke semua kecamatan
                        </div>
                      </div>
