...
export default function DataPajakREKLAME() {
  ...
  const [jenispajak, setJenisPajak] = React.useState<string>("fuMg");
  ...
  return (
    <>
      <CardComponent
        ...
        title="Statistik Pajak REKLAME"
        description={
          <>
            <span className="italic text-xs">
              (Sumber : Pajak Statistik REKLAME)
            </span>
          </>
        }
        action={
