...
export default function DataPajakPBB() {
  ...
  const [jenispajak, setJenisPajak] = React.useState<string>("jguzZ");
  ...
  return (
    <>
      <CardComponent
        ...
        title="Statistik Pajak PBB"
        description={
          <>
            <span className="italic text-xs">
              (Sumber : Pajak Statistik PBB)
            </span>
          </>
        }
        action={
